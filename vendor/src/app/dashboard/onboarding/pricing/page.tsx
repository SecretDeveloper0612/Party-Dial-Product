           ...
           <div className="lg:col-span-2">
              ...
              >
                 <header className="mb-12">
                   ...
                   <h1 className="text-3xl font-black text-slate-900 uppercase  mb-3 tracking-tight">Set Pricing</h1>
                 ...
                 <section className="mb-12">
                    <h2 className="text-xs font-black uppercase tracking-widest text-slate-400 mb-6 pl-1 ">Standard Plate Rates</h2>
                 ...
                 <section>
                    <div className="flex items-center justify-between mb-8 px-1">
                       <h2 className="text-xs font-black uppercase tracking-widest text-slate-400 ">Custom Packages</h2>
                       ...
                       {packages.map(pkg => (
                         <div key={pkg.id} className="p-6 bg-slate-50/50 rounded-[28px] border border-slate-100 flex items-center justify-between group hover:border-pd-pink transition-all">
                            <div className="flex-1">
                               <input 
                                  className="text-sm font-black text-slate-900 uppercase  bg-transparent outline-none mb-1 block w-full"
                                  value={pkg.name}
                            ...
                            <div className="flex items-center gap-6">
                               <div className="flex items-center text-slate-900">
                                  <IndianRupee size={16} />
                                  <input 
                                     className="w-16 bg-transparent text-lg font-black  outline-none text-right"
                                     value={pkg.price}
                 ...
                 <div className="mt-12 flex items-center justify-between pt-8 border-t border-slate-50">
                    <p className="text-xs text-slate-400 font-medium ">Customers will see &ldquo;Starting from ₹{perPlateVeg || '...'}&rdquo;</p>
                    <button 
                      onClick={handleSave}
                      disabled={isSaving}
                    ...
                    >
                      {isSaving ? (
                        ...
                        <>
                          <span className="">Complete Onboarding</span>
                          <ArrowRight size={18} />
                        </>
                      )}
                    </button>
              ...
              <div className="sticky top-12 space-y-6">
                 ...
                 <div className="bg-slate-900 rounded-[35px] p-8 text-white relative overflow-hidden group">
                    <div className="relative z-10">
                       ...
                       <h3 className="text-lg font-bold  mb-4">Competitive Pricing</h3>
                       ...
                       <div className="p-4 bg-white/5 rounded-2xl border border-white/5 text-[11px]  text-slate-300">
