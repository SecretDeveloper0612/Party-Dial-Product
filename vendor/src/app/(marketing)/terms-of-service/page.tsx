...
const TermsOfService = () => {
  ...
  return (
    <main className="bg-white min-h-screen text-slate-700 font-sans leading-relaxed selection:bg-pd-red/10 selection:text-pd-red">
      {/* 1. HERO HEADER */}
      <section className="pt-32 pb-12 px-6 bg-linear-to-b from-slate-50 to-white overflow-hidden relative border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div {...fadeUp} className="mb-6">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight tracking-tighter mb-4  uppercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-20">
          ...
          <aside className="lg:col-span-1 border-r border-slate-100 pr-8 hidden lg:block">
            <div className="sticky top-24 space-y-2">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-6  underline decoration-pd-red/20 underline-offset-4">Agreement Sections</p>
              ...
              <div className="mt-12 pt-12 border-t border-slate-100">
                <Link href="/contact" className="p-6 bg-slate-900 rounded-2xl block text-center group transition-all hover:bg-black">
                  <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2  leading-none">Legal Desk</p>
                  <p className="text-white font-bold text-xs uppercase tracking-tight  border-b border-white/10 pb-2 mb-4">Merchant Relations</p>
                  <button className="w-full bg-pd-red text-white py-2 rounded-lg font-black text-[9px] uppercase tracking-[0.2em] shadow-lg group-hover:scale-105 transition-transform  leading-none">Email Counsel</button>
                </Link>
              </div>
            </div>
          </aside>
          ...
          <article className="lg:col-span-3 space-y-16">
            ...
            <motion.div {...fadeUp} id="acceptance" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                <p>
                  This Merchant Agreement ("Agreement") governs the relationship between Preet Tech OPC Private Limited (operator of "PartyDial") and the Venue Merchant ("Partner"). By registering on the Partner Dashboard, you agree to these commercial terms.
                </p>
                <p>
                ...
                <ul className="list-none space-y-4 mt-6">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 group bg-slate-50 p-4 rounded-xl border border-slate-100 transition-all hover:shadow-md">
                      ...
                      <span className="font-bold text-slate-800 text-xs md:text-sm  uppercase tracking-tight">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <ul className="list-none space-y-2 mt-4 ml-2">
                  <li className="flex items-center gap-3">
                    ...
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">All payments are processed securely via Razorpay.</p>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pd-blue"></div>
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">Fees are non-refundable once the subscription period begins.</p>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pd-blue"></div>
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">Leads provided are for the exclusive use of the registered venue.</p>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.3 }} id="content-rights" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <div className="p-6 bg-slate-900 rounded-2xl border border-white/5 relative overflow-hidden group mt-8">
                  ...
                  <h3 className="text-white font-black  uppercase tracking-widest mb-4 inline-block border-b-2 border-pd-pink pb-1 leading-none">Intellectual Property</h3>
                  <p className="text-white/60 text-xs md:text-sm font-medium leading-relaxed  relative z-10">
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.4 }} id="termination" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify pb-10">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-pd-red/5 rounded-xl border border-pd-red/10">
                    <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2 ">Immediate Termination</p>
                    <p className="text-[11px] font-medium text-slate-500 ">PartyDial reserves the right to suspend accounts immediately in case of fraudulent activity or consistent customer complaints.</p>
                  </div>
                  <div className="p-4 bg-pd-red/5 rounded-xl border border-pd-red/10">
                    <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2 ">Data Access</p>
                    <p className="text-[11px] font-medium text-slate-500 ">Upon termination, the Partner will have 7 days to export lead data before dashboard access is revoked.</p>
                  </div>
                </div>
                <p className="mt-8">
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6  uppercase tracking-tighter ">Partner <span className="text-pd-red">Enquiries.</span></h2>
            <p className="text-slate-500 font-medium mb-10  text-sm">For amendments or custom enterprise contracts, please reach out to our legal department.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/contact" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto bg-slate-900 text-white px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-black transition-all active:scale-95 shadow-xl  leading-none">Contact Legal</button>
              </Link>
              <Link href="/" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto bg-white border border-slate-200 text-slate-400 px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:border-pd-red hover:text-pd-red transition-all active:scale-95  leading-none">Platform Home</button>
              </Link>
            </div>
