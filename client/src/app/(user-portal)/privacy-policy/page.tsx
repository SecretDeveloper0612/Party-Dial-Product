    ...
    <main className="bg-white min-h-screen text-slate-700 font-sans leading-relaxed selection:bg-pd-blue/10 selection:text-pd-blue">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-20">
          ...
          <aside className="lg:col-span-1 border-r border-slate-100 pr-8 hidden lg:block">
            <div className="sticky top-24 space-y-2">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-6  underline decoration-pd-blue/20 underline-offset-4">Policy Navigation</p>
              ...
              <div className="mt-12 pt-12 border-t border-slate-100">
                 <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-[11px] font-medium text-slate-500 ">privacy@partydial.com</p>
                    </div>
                 </div>
              </div>
            </div>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                  <div className="p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-xl transition-all group">
                     ...
                     <h3 className="text-xs font-black uppercase tracking-widest text-slate-900  mb-2">Personal Data</h3>
                  ...
                  <div className="p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-xl transition-all group">
                     ...
                     <h3 className="text-xs font-black uppercase tracking-widest text-slate-900  mb-2">Usage Data</h3>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <div className="p-6 bg-slate-900 rounded-3xl border border-white/5 relative overflow-hidden group mt-6">
                   <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                      ...
                      <div>
                         <h3 className="text-white font-black  uppercase tracking-widest mb-1 text-sm">Venue Partners Only</h3>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6">
                  <div className="p-4 bg-emerald-400/[0.03] border border-emerald-400/10 rounded-xl text-center group hover:border-emerald-400 transition-all">
                      <p className="text-[10px] font-black uppercase tracking-widest text-emerald-400  mb-2 leading-none">Access</p>
                      <p className="text-[9px] font-medium text-slate-500 ">Request a copy of your personal data stored with us.</p>
                  </div>
                  <div className="p-4 bg-emerald-400/[0.03] border border-emerald-400/10 rounded-xl text-center group hover:border-emerald-400 transition-all">
                      <p className="text-[10px] font-black uppercase tracking-widest text-emerald-400  mb-2 leading-none">Update</p>
                      <p className="text-[9px] font-medium text-slate-500 ">Modify your account information from your profile dashboard.</p>
                  </div>
                  <div className="p-4 bg-emerald-400/[0.03] border border-emerald-400/10 rounded-xl text-center group hover:border-emerald-400 transition-all">
                      <p className="text-[10px] font-black uppercase tracking-widest text-emerald-400  mb-2 leading-none">Delete</p>
                      <p className="text-[9px] font-medium text-slate-500 ">Request permanent removal of your account and data.</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-slate-950 text-white rounded-[4rem] mx-4 mb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl font-black mb-6  uppercase tracking-tighter ">Policy <span className="text-pd-blue">Updates.</span></h2>
            ...
            <Link href="/contact" className="inline-block">
                <button className="bg-pd-blue text-white px-10 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-pd-blue/80 transition-all active:scale-95 shadow-xl  leading-none">Reach Our Privacy Team</button>
            </Link>
