    ...
    <main className="bg-white min-h-screen text-slate-700 font-sans leading-relaxed selection:bg-pd-red/10 selection:text-pd-red">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-20">
          ...
          <aside className="lg:col-span-1 border-r border-slate-100 pr-8 hidden lg:block">
            <div className="sticky top-24 space-y-2">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-6  underline decoration-pd-red/20 underline-offset-4">Table of Contents</p>
              ...
              <div className="mt-12 pt-12 border-t border-slate-100">
                <Link href="/contact" className="p-6 bg-slate-900 rounded-2xl block text-center group transition-all hover:bg-black">
                  <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2  leading-none">Questions?</p>
                  <p className="text-white font-bold text-xs uppercase tracking-tight  border-b border-white/10 pb-2 mb-4">Contact Our Legal Team</p>
                  <button className="w-full bg-pd-red text-white py-2 rounded-lg font-black text-[9px] uppercase tracking-[0.2em] shadow-lg group-hover:scale-105 transition-transform  leading-none">Email Support</button>
                </Link>
              </div>
            </div>
          </aside>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <ul className="list-none space-y-2 mt-4 ml-2">
                  <li className="flex items-center gap-3">
                    ...
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">Providing false or misleading information during registration or inquiry.</p>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pd-blue"></div>
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">Attempting to interfere with the proper working of the platform.</p>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-pd-blue"></div>
                    <p className="font-bold text-slate-700  border-b border-pd-blue/20 pb-1 w-full">Engaging in any automated use of the system, such as using scripts to collect data.</p>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.3 }} id="privacy" className="scroll-mt-24">
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify">
                ...
                <div className="p-6 bg-slate-900 rounded-2xl border border-white/5 relative overflow-hidden group mt-8">
                  ...
                  <h3 className="text-white font-black  uppercase tracking-widest mb-4 inline-block border-b-2 border-pd-pink pb-1 leading-none">Transparency Commitment</h3>
              ...
              <div className="space-y-4 text-slate-600 font-medium leading-[1.8] text-sm md:text-base  border-l-2 border-slate-100 pl-6 md:pl-10 text-justify pb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-pd-red/5 rounded-xl border border-pd-red/10">
                    <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2 ">Venue Quality</p>
                    <p className="text-[11px] font-medium text-slate-500 ">We are not responsible for the actual quality, safety, or legality of the venues booked through our platform.</p>
                  </div>
                  <div className="p-4 bg-pd-red/5 rounded-xl border border-pd-red/10">
                    <p className="text-[10px] font-black text-pd-red uppercase tracking-widest mb-2 ">Transactions</p>
                    <p className="text-[11px] font-medium text-slate-500 ">All financial transactions and booking agreements are made directly between the user and the venue owner.</p>
                  </div>
                </div>
                <p className="mt-8">
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-6  uppercase tracking-tighter ">Still have <span className="text-pd-red">Questions?</span></h2>
            <p className="text-slate-500 font-medium mb-10  text-sm">Our legal and support teams are here to clarify any doubts regarding our service operations.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/contact" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto bg-slate-900 text-white px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-black transition-all active:scale-95 shadow-xl ">Contact Support</button>
              </Link>
              <Link href="/" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto bg-white border border-slate-200 text-slate-400 px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:border-pd-red hover:text-pd-red transition-all active:scale-95 ">Back to Home</button>
              </Link>
            </div>
